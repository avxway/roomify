...
router.get('/api/projects/list', async ({ user }) => {
    try {
        ...
        return jsonError(500, 'Failed to list the projects', { message: e.message || 'Unknown error' });
    }
})
...
router.get('/api/projects/get', async ({ request, user }) => {
    try {
        ...
        return jsonError(500, 'Failed to get the project', { message: e.message || 'Unknown error' });
    }
})